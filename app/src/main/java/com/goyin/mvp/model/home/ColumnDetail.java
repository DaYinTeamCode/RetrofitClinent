...
public class ColumnDetail {
     ...
     * icon_name : f0a531a7198cac2ba0747c435644d690.jpg
     * small_icon_name :
     * orderdisplay : 2
     * rank_score : 0
     * night_rank_score : 0
    ...
    public String toString() {
        return "ColumnDetail{" +
                ...
                ", night_rank_score='" + night_rank_score + '\'' +
                ", nums='" + nums + '\'' +
                ", push_ios='" + push_ios + '\'' +
                ", push_home='" + push_home + '\'' +
                ", is_game_cate='" + is_game_cate + '\'' +
                ", cate_id='" + cate_id + '\'' +
                ", is_del='" + is_del + '\'' +
                ", is_relate='" + is_relate + '\'' +
                ", push_vertical_screen='" + push_vertical_screen + '\'' +
                ", push_qqapp='" + push_qqapp + '\'' +
                ", broadcast_limit='" + broadcast_limit + '\'' +
                ", vodd_cateids='" + vodd_cateids + '\'' +
                ", pic_url='" + pic_url + '\'' +
                ", url='" + url + '\'' +
                ", icon_url='" + icon_url + '\'' +
